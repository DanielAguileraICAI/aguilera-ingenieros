...
window.AI_I18N = {
  es: {
    ...
    home: {
      heroSlides: [
        { eyebrow: "Centros de Proceso de Datos", headline: "Infraestructura crítica. Diseñada para no fallar.", sub: "Tier III y Tier IV. Redundancia total. Eficiencia energética.", img: "assets/hero_bbva_noche.jpg", objectPosition: "center 10%" },
  ...
  en: {
    ...
    home: {
      heroSlides: [
        { eyebrow: "Data Centers",                 headline: "Critical infrastructure. Designed to never fail.", sub: "Tier III and Tier IV. Full redundancy. Energy-efficient.",   img: "assets/hero_bbva_noche.jpg", objectPosition: "center 10%" },
